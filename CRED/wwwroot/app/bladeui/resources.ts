export class Resources {
    static Prepend(prepend: string, resources: string[]): string[] {
    ...
    static Urls: any = new class {
        Templates: any = new class {
            ...
            TopBar = this.widgetsPath + "topbar/topbar.component.html";
    ...
    static WidgetBase2 = Resources.Prepend("./app/bladeui/azure/", [
        //"hiddenfix.css",
